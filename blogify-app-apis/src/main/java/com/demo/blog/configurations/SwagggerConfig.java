...
public class SwagggerConfig {
	...
	//by using Authorization we pass key from client
	...
	private ApiInfo getInfo() {
		return new ApiInfo("Blogging Application : Backend Course",
				"This project is developed by Samundar Singh Rathore", 
				"1.0", "Terms of Service",
				new Contact("Samundar", "https://abhastra.com", "abhastra1@gmail.com"),
